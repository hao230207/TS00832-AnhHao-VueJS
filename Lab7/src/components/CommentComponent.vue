<template>
  <div class="col-sm-4 m-5">
    ...
    <div class="card">
      <img src="../assets/img1.png" alt="Hình ảnh" class="card-img-top" />
    ...
    <form @submit.prevent="submitComment">
      <div class="mt-3">
        <textarea id="commentText" class="form-control" rows="3" v-model="commentText" placeholder="Nhập bình luận của bạn"></textarea>
      </div>
